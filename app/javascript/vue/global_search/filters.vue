<template>
  <div class="max-w-[600px] p-3.5">
    <div class="sci-label mb-2">Filter by type</div>
    ...
    <div class="sci-label mb-2">Filter by created date</div>
    <DateFilter
      :date="createdAt"
    ...
    ></DateFilter>
    <div class="sci-label mb-2">Filter by updated</div>
    <DateFilter
      :date="updatedAt"
    ...
    ></DateFilter>
    <div class="sci-label mb-2">Filter by team</div>
    ...
    <div class="sci-label mb-2">Filter by user</div>
    ...
    <div class="flex items-center gap-6">
      ...
      <button class="btn btn-secondary ml-auto" @click="$emit('cancel')">Cancel</button>
