<template>
  <div id="repository-item-sidebar"
    class="w-[500px] min-h-[1032px] h-auto m-[24px] bg-white justify-between flex flex-col">
          ...
          <div id="custom-columns-wrapper" class="flex flex-col min-h-[64px] h-auto">
            ...
            <div v-if="customColumns?.length > 0" class="flex flex-col gap-4 w-[350px] h-auto">
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="">
                  <div v-if="customColumns[0]?.solventStock" class="flex flex-row justify-between">
                    <div class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                      {{ customColumns[0]?.solventStock }}
                    </div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.itemsInWarehouse ? 'In stock' : 'No text' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.storageTemp || 'No text' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.samplingDateTimeRange || 'No date & time range' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="">
                  <div v-if="customColumns[0]?.samplingDateTimeReminder" class="flex flex-row justify-between">
                    <div class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                      {{ customColumns[0]?.samplingDateTimeReminder }}
                    </div>
                    <i class="sn-icon sn-icon-notifications"></i>
                  </div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.samplingDateRange || 'No date range' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.samplingDate || 'No date' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="">
                  <div v-if="customColumns[0]?.samplingDateReminder" class="flex flex-row justify-between">
                    <div class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                      {{ customColumns[0]?.samplingDateReminder }}
                    </div>
                    <i class="sn-icon sn-icon-notifications"></i>
                  </div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.samplingTimeRange || 'No time range' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.incubationTime || 'No time' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  <a v-if="customColumns[0]?.dnaFile">
                    <div @mouseover="tooltipShowing = true" @mouseout="tooltipShowing = false"
                      @mousemove="handleTooltipMouseMove" class="w-fit cursor-pointer text-sn-science-blue">
                      {{ customColumns[0]?.dnaFile }}
                      <tooltip-preview v-if="tooltipShowing" tooltipId="dna-file-tooltip"></tooltip-preview>
                    </div>
                  </a>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.numOfAliquots || 'No number' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.color || 'No selection' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  <div v-if="customColumns[0]?.optionArr.length > 0"
                    class="flex flex-row overflow-auto break-normal w-[350px] gap-1 flex-wrap h-auto">
                    <div v-for="(option, index) in customColumns[0].optionArr" :key="index" class="flex min-w-fit">
                      {{ option + ' |' }}
                    </div>
                  </div>
              ...
              <div id="" class="flex flex-col min-min-h-[46px] h-auto gap-[6px]">
                ...
                <div id="" class="text-sn-dark-grey font-inter text-sm font-normal leading-5">
                  {{ customColumns[0]?.itemStatus || 'No selection' }}
                </div>
              </div>
              <div id="dashed-divider" class="flex h-[1px] py-0  border-dashed border-[1px] border-sn-light-grey"></div>
              ...
              <div id="" class="flex flex-col min-min-h-[46px] h-auto gap-[6px]">
                <div id="" class="flex justify-between">
                  ...
                  <div @click="toggleExpandSequence"
                    class="font-inter text-sm font-normal leading-5 text-sn-blue cursor-pointer">
                    {{ sequenceExpanded ? 'Hide' : 'Show' }}
                  </div>
                </div>
                <div id="sequence-container"
                  ...
                  {{ customColumns[0]?.sequence || 'No text' }}
                </div>
              </div>
        ...
        <div id="navigation" class="min-w-[130px] h-[130px] flex item-end gap-x-4	">
          <div class="flex flex-col py-2 px-0 gap-3 self-stretch w-[130px] h-[130px]  justify-center items-center">
            <div class="flex flex-col w-[130px] h-[130px] justify-between text-right">
              <div @click="handleSideNavClick" id="text-item-1" class="hover:cursor-pointer text-sn-grey">Information
              </div>
...
export default {
  ...
  methods: {
    // for calculating position of tooltip relative to cursor
    handleTooltipMouseMove(e) {
      const tooltipToTarget = document.getElementById('dna-file-tooltip')
      if (this.tooltipShowing && tooltipToTarget) {
        tooltipToTarget.style.left = `${-600 / 16 + e.pageX / 16}rem`
      }
    },
    ...
    // for toggling sequence full view
