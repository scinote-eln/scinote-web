...
import {
  ...
  link_users_my_module_user_my_modules_path
} from '../../routes.js';
  ...
  methods: {
    ...
    loadUsers() {
      ...
      axios.get(usersUrl).then((response) => {
        ...
        this.users = this.myModule.attributes.designated_users || [];
      });
    },
    usersRenderer(user) {
    ...
    setUsers(value) {
      axios.post(link_users_my_module_user_my_modules_path({ my_module_id: this.myModule.id }), {
        user_ids: value
      }).then(() => {
        this.reloadMyModule();
      })
