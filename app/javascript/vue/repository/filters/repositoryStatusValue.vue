<template>
  <div class="filter-attributes">
    ...
    <SelectDropdown
      ...
      :fewOptionsPlaceholder="this.i18n.t('repositories.show.repository_filter.filters.types.RepositoryStatusValue.multiple_selected')"
      :allOptionsPlaceholder="this.i18n.t('repositories.show.repository_filter.filters.types.RepositoryStatusValue.all_selected')"
