...
module GenerateNotificationModel
  ...
  def generate_notification_description_elements(object, elements = [])
    ...
    when Experiment
      path = Rails.application.routes.url_helpers.list_modules_experiment_path(object)
    ...
    when MyModule
      path = if object.archived?
               Rails.application.routes.url_helpers.list_modules_experiment_path(object.experiment,
                                                                                 view_mode: :archived)
             else
