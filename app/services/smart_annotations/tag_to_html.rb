...
module SmartAnnotations
  class TagToHtml
    ...
    def initialize(user, team, text, preview = false)
      parse(user, team, text, preview)
    end
    ...
    def parse(user, team, text, preview = false)
      @html = text.gsub(REGEX) do |el|
        ...
        begin
          ...
          if type == 'rep_item'
            repository_item(value[:name], user, team, type, object, preview)
          else
