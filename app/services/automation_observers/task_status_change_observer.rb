...
module AutomationObservers
  class TaskStatusChangeObserver < BaseObserver
    def self.on_update(my_module, user)
      ...
      return unless (my_module.saved_change_to_my_module_status_id? && my_module.my_module_status.previous_status_id == my_module.my_module_status_id_previously_was) ||
                    (my_module.saved_change_to_archived && !my_module.archived) ||
                    my_module.saved_change_to_experiment_id?
