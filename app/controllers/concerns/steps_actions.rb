module StepsActions
  ...
  def checklist_item_annotation(step, checklist_item, old_text = nil)
    smart_annotation_notification(
      ...
      subject: checklist_item.checklist.step_orderable_element,
  ...
  def step_text_annotation(step, step_text, old_text = nil)
    smart_annotation_notification(
      ...
      subject: step_text.step_orderable_element,
  ...
  def checklist_name_annotation(step, checklist, old_text = nil)
    smart_annotation_notification(
      ...
      subject: checklist.step_orderable_element,
      title: t('notifications.checklist_title',
               user: current_user.full_name,
               step: step.name),
      message: annotation_message(step)
  ...
  def table_content_annotation(step, table, old_content = nil)
    smart_annotation_notification(
      ...
      subject: table.step_table.step_orderable_element,
