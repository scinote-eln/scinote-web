...
class NavigationsController < ApplicationController
  ...
  def settings_menu_links
    ...
    links.insert(1, { name: I18n.t('users.settings.sidebar.account_nav.team_automations'), url: team_automations_team_path(current_team) }) if can_manage_team?(current_team)
