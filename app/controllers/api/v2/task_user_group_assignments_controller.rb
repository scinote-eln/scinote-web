...
module Api
  module V2
    class TaskUserGroupAssignmentsController < BaseController
      ...
      def index
        user_group_assignments = timestamps_filter(@task.user_group_assignments).page(params.dig(:page, :number))
      ...
      def update
        ...
        ActiveRecord::Base.transaction do
          ...
          log_activity(:my_module_access_changed_user_group)
          propagate_job
        end
      ...
      def load_user_group_assignment
        @user_group_assignment = @task.user_group_assignments.find(params.require(:id))
      end
