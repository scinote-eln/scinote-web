...
module StepElements
  class FormResponsesController < BaseController
    ...
    def create
      ...
      render json: StepFormResponseSerializer.new(@form_response, scope: { user: current_user }).as_json
    end
    ...
    def reset
      ...
      render json: StepFormResponseSerializer.new(new_form_response, scope: { user: current_user }).as_json
    end
