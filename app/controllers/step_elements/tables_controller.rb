...
module StepElements
  class TablesController < BaseController
    ...
    def create
      ...
      render_element(TableSerializer, step_table.table)
    ...
    def update
      ...
      render_element(TableSerializer, @table)
    rescue ActiveRecord::RecordInvalid
      head :unprocessable_entity
    end
    ...
    def duplicate
      ActiveRecord::Base.transaction do
        ...
        render_element(TableSerializer, new_table.step_table.table)
      end
    rescue ActiveRecord::RecordInvalid
      head :unprocessable_entity
    end
    ...
    def check_lock_permissions
      render_403 unless can_lock_step_table?(@table)
    end
    ...
    def log_restore_activity
      log_step_restore_activity(:task_step_table_restored, { table_name: @element.name })
    end
