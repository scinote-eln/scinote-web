...
Rails.application.config.assets.precompile += %w(my_modules/show.js)
...
Rails.application.config.assets.precompile += %w(widgets/my_module/widget_results.js)
...
Rails.application.config.assets.precompile += %w(widgets/my_module/widget_samples.js)
