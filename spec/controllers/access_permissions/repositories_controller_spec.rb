...
describe AccessPermissions::RepositoriesController, type: :controller do
  login_user

  let!(:user) { subject.current_user }
  let!(:team) { create :team, created_by: user }
  let!(:object) { create :repository, team: team, created_by: user  }
  ...
  include_context 'reference_access_controller', { object_name: 'repository' }
end
